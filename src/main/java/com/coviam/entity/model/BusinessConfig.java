...
public class BusinessConfig extends Auditable<String> {
    ...
    private Enum busniessStatus = com.coviam.util.ProviderStatus.active;
    ...
    public com.coviam.entity.model.ProviderConfig getProviderConfig() {
        return providerConfig;
    }

    public void setProviderConfig(com.coviam.entity.model.ProviderConfig providerConfig) {
